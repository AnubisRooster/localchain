...
import (
	_ "localchain/x/records/module"
	recordsmoduletypes "localchain/x/records/types"
	"time"
...
var (
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			{
				Name:   recordsmoduletypes.ModuleName,
				Config: appconfig.WrapAny(&recordsmoduletypes.Module{}),
			}},
	})
)
